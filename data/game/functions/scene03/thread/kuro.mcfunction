...
execute if score state TalkState matches 0..1 as @a[scores={Sight=0}] at @s if block ~ 75 ~ minecraft:brown_terracotta run scoreboard players set @s Sight 1
...
execute if score state TalkState matches 6.. as @a[scores={Sight=0}] at @s if block ~ 75 ~ minecraft:brown_terracotta run scoreboard players set @s Sight 1
execute as @a if score @s Sight matches 1 run function game:scene03/thread/act/sight
...
execute if score state TalkState matches 6.. if score *find Sight matches 0 as @e[tag=kuro] at @s run scoreboard players set @a[distance=..2] Sight 40
