...
# チョークを持っている
execute as @p[team=blue] if entity @s[nbt={SelectedItem:{id:"minecraft:pink_dye"}}] run scoreboard players set hand _Item 2

# はずれアイテムを持っている
execute as @p[team=blue] if entity @s[nbt={SelectedItem:{id:"minecraft:green_dye"}}] run scoreboard players set hand _Item 3
execute as @p[team=blue] if entity @s[nbt={SelectedItem:{id:"minecraft:gray_dye"}}] run scoreboard players set hand _Item 3
execute as @p[team=blue] if entity @s[nbt={SelectedItem:{id:"minecraft:white_dye"}}] run scoreboard players set hand _Item 3
execute as @p[team=blue] if entity @s[nbt={SelectedItem:{id:"minecraft:black_dye"}}] run scoreboard players set hand _Item 3
