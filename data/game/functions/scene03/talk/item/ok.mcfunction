...
execute if score n Talk matches 5 run tellraw @p[team=blue] "そのチョークで「扉」を完成させてみてください"
execute if score n Talk matches 6 run tellraw @p[team=blue] "別にあなた達の血でもいいんですが、嫌でしょう？"
execute if score n Talk matches 7 run tellraw @p[team=blue] "…なぜ、こんなこと知っているのか私も分からないんですが…"
execute if score n Talk matches 8 run tellraw @p[team=blue] "昔、誰かに聞いた…？いえ、誰かと…？"
execute if score n Talk matches 9 run tellraw @p[team=blue] "やっぱり、思い出せないみたいです"
...
execute if score n Talk matches 7 run tellraw @p[team=red] "＃＃＃＃Ｊｔ＃＃＃＃＃＃＃＃＃＃ｒＦ＃＃＃ＵＢ＃＃＃＃＃"
execute if score n Talk matches 8 run tellraw @p[team=red] "＃＃＃＃ＧＢＰ＃＃＃＃＃＃＃＃＃Ｔ＃"
execute if score n Talk matches 9 run tellraw @p[team=red] "＃＃ｎ＃＃＃＃＃＃ＵＢ＃"
