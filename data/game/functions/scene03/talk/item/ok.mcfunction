...
execute if score n Talk matches 2 run tellraw @p[team=blue] "次は開かずの教室に行ってきて、なにか取ってきてちょうだい"
...
execute if score n Talk matches 7 run tellraw @p[team=blue] "完成させて光についていけば開かずの教室に行けると思うわ"
