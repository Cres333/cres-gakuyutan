...
execute unless score n Talk = max Talk run schedule function game:scene03/talk/t01 5s
...
execute if score n Talk = max Talk run scoreboard players set exec Any 1
