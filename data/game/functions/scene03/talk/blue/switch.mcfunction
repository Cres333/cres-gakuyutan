...
execute if score state TalkState matches 6 if score *count Memory matches 1..3 run function game:scene03/talk/t03/part
execute if score state TalkState matches 6 if score *count Memory matches 4.. run function game:scene03/talk/t03/all
