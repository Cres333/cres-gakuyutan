...
execute if score n Talk matches 9 positioned -72 67 5 if block ~ ~ ~ minecraft:barrel run replaceitem block ~ ~ ~ container.8 minecraft:white_banner
...
execute if score n Talk >= max Talk run function game:scene03/t03end
