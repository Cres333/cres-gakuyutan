...
execute if score n Talk matches 6 run tellraw @p[team=blue] "…もし、詳しいことを知りたければ、これを持ってきてくれますか？"
execute if score n Talk matches 7 run tellraw @p[team=blue] "そこに書かれた物を持って来ることができたら、"
execute if score n Talk matches 8 run tellraw @p[team=blue] "私が知っていることを教えてあげます"
