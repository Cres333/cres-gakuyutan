...
execute unless score n RTalk >= max RTalk run schedule function game:scene03/talk/t02/redsub1 5s
...
execute if score n RTalk >= max RTalk run schedule function game:scene03/talk/separate_red 1s
