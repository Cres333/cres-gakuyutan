...
execute if score n _Mem4 >= max _Mem4 as @p[team=red,scores={Memory=4}] run tp @p[team=red] -58 67.5 3 90 0
execute if score n _Mem4 >= max _Mem4 as @p[team=blue,scores={Memory=4}] run tp @p[team=blue] -58 67.5 3 90 0
