...
execute if score n _Mem2 >= max _Mem2 as @p[team=red,scores={Memory=2}] run tp @p[team=red] -58 67.5 3 90 0
execute if score n _Mem2 >= max _Mem2 as @p[team=blue,scores={Memory=2}] run tp @p[team=blue] -58 67.5 3 90 0
execute if score n _Mem2 >= max _Mem2 run scoreboard players set @p[scores={Memory=2}] Memory 0
execute if score n _Mem2 >= max _Mem2 run scoreboard objectives remove _Mem2
