...
execute if score n _Mem1 >= max _Mem1 as @p[team=red,scores={Memory=1}] run tp @p[team=red] -58 67.5 3 90 0
execute if score n _Mem1 >= max _Mem1 as @p[team=blue,scores={Memory=1}] run tp @p[team=blue] -58 67.5 3 90 0
